        ...
        items: [
          {
            ...
            title: 'Evidence-led',
            slug: 'evidence-led',
            description: 'Each compound earns its place through peer-reviewed science, not wellness trends.',
            type: 'home',
            order: 0,
            createdAt: '',
            updatedAt: '',
          },
          {
            ...
            description: 'Every batch is independently tested. Certificates of analysis, always available.',
            type: 'home',
            order: 1,
            createdAt: '',
            updatedAt: '',
